...
namespace Old_Game_Conversion
{
    class InteractionSet
    {
        ...
        public virtual void SetGuiElement(GuiElement aElement)
        {
            guiElements.Add(aElement);
        }

        public virtual void RemoveGuiElement(GuiElement aElement)
        {
            guiElements.Remove(aElement);
        }
